...
const Ranges = () => {
    ...
    const handleClick = async (event, serviceName) => {
        ...
        await fetch('http://35.2.2.224:5000/api/v1/settings/ranges/', {method: 'delete', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({'serviceName': serviceName})})
        ...
        <Box style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '90vw'}}>
            <Box style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', width: '80vw', minHeight: '80vh'}}>
                ...
                <Box style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <form action='http://35.2.2.224:5000/api/v1/settings/ranges/?target=/settings/ranges' method='post' encType='multipart/form-data'>
